...
// import hook untuk mengambil data permission
...
const Permissions: React.FC = () => {
  //title
  useEffect(() => {
    document.title = "Permissions - City Santri Kab. Depok";
  }, []);
  ...
  // Update query string di URL saat search atau page berubah
  useEffect(() => {
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1 italic">
              Manage your system permissions. Add, edit, or delete access
              rights.
            </p>
          </div>
