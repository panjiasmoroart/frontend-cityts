...
// import hook untuk mengambil data sliders
...
const Slider: React.FC = () => {
  //title
  useEffect(() => {
    document.title = "Sliders - City Santri Kab. Depok";
  }, []);
  ...
  return (
    <AdminLayout>
      <div className="p-5">
        {hasAnyPermission(["sliders-create"]) && <Create />}
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1 italic">
              Display, add, or remove images from the homepage slider.
            </p>
          </div>
        </div>
